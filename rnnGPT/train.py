...
def train():
    ...
    model = LanguageModel(tokenizer.vocab_size, n_embd, n_layer, CONTEXT_SIZE, device)
    model = model.to(device)
    # print the number of parameters in the model
    print(f'Network contains {sum(p.numel() for p in model.parameters())/1e6:.2f}M parameters...')
